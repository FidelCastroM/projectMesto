export default class Card {
    ...
    _getTemplate() {
        ...
        this._deleteButton = cardElement.querySelector('.element__basket');
        this._imageCard = cardElement.querySelector('.element__image');
        this._titleCard = cardElement.querySelector('.element__landscape');
        this._counterLikes = cardElement.querySelector('.element__like-quantity');
        return cardElement;
    }
    ...
    toggleLike() {
        !this._likeButton.classList.contains('element__like_active') ? this._handlePutLike(this) : this._handleDeleteLike(this);
    }
    _setEventListeners() {
